...
pub const ALL_COMMANDS: &[Command] = &[
    ...
    Command::SplitEditor,
    Command::QuickOpen,
    Command::SearchEditorNew,
    Command::SearchEditorRerun,
    Command::GoToSymbol,
...
impl Command {
    ...
    pub fn title(self) -> &'static str {
        match self {
            ...
            Command::SearchEditorNew => "Search Editor: Open New Search Editor",
            Command::SearchEditorRerun => "Search Editor: Search Again",
    ...
    pub fn id(self) -> &'static str {
        match self {
            ...
            Command::SearchEditorNew => "search_editor_new",
            Command::SearchEditorRerun => "search_editor_rerun",
