...
pub const ALL_COMMANDS: &[Command] = &[
    ...
    Command::EditHitCount,
    Command::AddFunctionBreakpoint,
    Command::BreakOnValueChange,
    Command::RunToCursor,
...
impl Command {
    ...
    pub fn title(self) -> &'static str {
        match self {
            ...
            Command::EditHitCount => "Debug: Edit Hit Count",
            Command::AddFunctionBreakpoint => "Debug: Add Function Breakpoint",
            Command::BreakOnValueChange => "Debug: Break on Value Change",
            Command::RunToCursor => "Debug: Run to Cursor",
    ...
    pub fn keybinding_hint(self) -> &'static str {
        match self {
            ...
            Command::EditHitCount => "Ctrl+Shift+F9",
            Command::AddFunctionBreakpoint => "Ctrl+F9",
            Command::BreakOnValueChange => "Ctrl+Alt+F9",
            Command::RunToCursor => "Ctrl+F10",
    ...
    pub fn id(self) -> &'static str {
        match self {
            ...
            Command::EditHitCount => "edit_hit_count",
            Command::AddFunctionBreakpoint => "add_function_breakpoint",
            Command::BreakOnValueChange => "break_on_value_change",
            Command::RunToCursor => "run_to_cursor",
