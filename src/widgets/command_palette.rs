...
impl Command {
    ...
    pub fn title(self) -> &'static str {
        match self {
            ...
            Command::CreateProfile => "Profiles: Create Profile",
            Command::UseProfileInWorkspace => "Profiles: Use Profile in This Workspace",
    ...
    pub fn id(self) -> &'static str {
        match self {
            ...
            Command::CreateProfile => "create_profile",
            Command::UseProfileInWorkspace => "use_profile_in_workspace",
