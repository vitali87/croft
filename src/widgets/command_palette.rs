...
impl Command {
    ...
    pub fn title(self) -> &'static str {
        match self {
            ...
            Command::GitInteractiveRebase => "Git: Interactive Rebase...",
            Command::GitContinueRebase => "Git: Continue Rebase",
            Command::GitAbortRebase => "Git: Abort Rebase",
    ...
    pub fn id(self) -> &'static str {
        match self {
            ...
            Command::GitInteractiveRebase => "git_interactive_rebase",
            Command::GitContinueRebase => "git_continue_rebase",
            Command::GitAbortRebase => "git_abort_rebase",
