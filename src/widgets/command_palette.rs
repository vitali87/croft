...
pub const ALL_COMMANDS: &[Command] = &[
    ...
    Command::TriggerInlineCompletion,
    Command::ToggleInlineCompletions,
...
impl Command {
    ...
    pub fn title(self) -> &'static str {
        match self {
            ...
            Command::TriggerInlineCompletion => "Editor: Trigger Inline Completion",
            Command::ToggleInlineCompletions => "Editor: Toggle Inline Completions",
    ...
    pub fn keybinding_hint(self) -> &'static str {
        match self {
            ...
            Command::ToggleAutoSaveOnFocusChange => "",
            Command::ToggleInlineBlame => "",
            Command::TriggerInlineCompletion => "Alt+\\",
            Command::ToggleInlineCompletions => "",
            Command::ToggleProvenance => "",
            Command::DiffToggleGroupBySeat => "",
            Command::ToggleIndentGuides => "",
    ...
    pub fn id(self) -> &'static str {
        match self {
            ...
            Command::TriggerInlineCompletion => "trigger_inline_completion",
            Command::ToggleInlineCompletions => "toggle_inline_completions",
