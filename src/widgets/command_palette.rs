...
pub const ALL_COMMANDS: &[Command] = &[
    ...
    Command::EditBreakpointHitCount,
    Command::AddFunctionBreakpoint,
    Command::RemoveFunctionBreakpoints,
    Command::DebugRunToCursor,
    Command::RemoveDataBreakpoints,
...
impl Command {
    ...
    pub fn title(self) -> &'static str {
        match self {
            ...
            Command::EditBreakpointHitCount => "Debug: Add Hit Count Breakpoint",
            Command::AddFunctionBreakpoint => "Debug: Add Function Breakpoint",
            Command::RemoveFunctionBreakpoints => "Debug: Remove All Function Breakpoints",
            Command::DebugRunToCursor => "Debug: Run to Cursor",
            Command::RemoveDataBreakpoints => "Debug: Remove All Data Breakpoints",
    ...
    pub fn id(self) -> &'static str {
        match self {
            ...
            Command::EditBreakpointHitCount => "edit_breakpoint_hit_count",
            Command::AddFunctionBreakpoint => "add_function_breakpoint",
            Command::RemoveFunctionBreakpoints => "remove_function_breakpoints",
            Command::DebugRunToCursor => "debug_run_to_cursor",
            Command::RemoveDataBreakpoints => "remove_data_breakpoints",
