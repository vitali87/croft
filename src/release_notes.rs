...
pub const RELEASE_NOTES: &[ReleaseNote] = &[ReleaseNote {
    kind: NoteKind::Fix,
    summary: "Dropping a file whose path has non-ASCII characters opens that file: the file:// URL decoder reassembles percent-encoded UTF-8 instead of reading each byte as a Latin-1 character.",
}];
