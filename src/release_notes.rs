...
pub const RELEASE_NOTES: &[ReleaseNote] = &[ReleaseNote {
    kind: NoteKind::Fix,
    summary: "A background update on a remote no longer kicks you out of the session: the host hands attached clients to its updated self instead of dropping them.",
}];
