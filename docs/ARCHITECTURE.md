...
└── widgets/
    ...
    ├── rust_deps.rs     collapsible RUST DEPENDENCIES section: the workspace's resolved crate set (name + version) parsed off-thread from `cargo metadata`; a ⋯-menu Explorer sub-view, display-only
